<div  class ="content mt-3">
				<div class ="card bg-primary bg-gradient">
					<div class="card-body">
						...
						<a href="pengguna.php" class="btn text-light">Pengguna</a>
						<a href="peminjam.php" class="btn text-light">Peminjaman</a>
						<a href="laporan_peminjam.php" class="btn text-light">Laporan Peminjaman</a>
