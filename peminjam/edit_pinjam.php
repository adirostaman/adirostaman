        ...
        <div class="col">
            <div class="bg-primary rounded h-100 p-4">
                ...
                <form method="POST" action="proses_update_pinjam.php">
                    ...
                    <div class="row mb-3">
                        <label for="inputText3" class="col-sm-2 col-form-label">tanggal_peminjaman</label>
                        <div class="col-sm-10">
                            <input name="tanggal_peminjaman" type="text" class="form-control" value="<?php echo $d_koleksi['tanggal_peminjaman']; ?>" readonly>
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputText3" class="col-sm-2 col-form-label">tanggal_pengembalian</label>
                        <div class="col-sm-10">
